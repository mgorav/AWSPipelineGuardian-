...
1. [Introduction](#1-introduction)
    - [1.1 Data Storage Locations](#11-data-storage-locations)
    - [1.2 Attribution of Ownership](#12-attribution-of-ownership)
    - [1.3 Runtime Execution Patterns](#13-runtime-execution-patterns)
    - [1.4 Underlying Data Preparation Logic](#14-underlying-data-preparation-logic)

2. [Large Language Models for Code Comprehension](#2-large-language-models-for-code-comprehension)
    - [2.1 CodeParrot](#21-codeparrot)
    - [2.2 PyMT5](#22-pymt5)
    - [2.3 Structformer](#23-structformer)

3. [Characterizing AWS Data Engineering Pipelines](#3-characterizing-aws-data-engineering-pipelines)
    - [3.1 Distributed Processing with PySpark on EMR](#31-distributed-processing-with-pyspark-on-emr)
    - [3.2 Orchestrated AWS Glue ETL Jobs](#32-orchestrated-aws-glue-etl-jobs)
    - [3.3 Automated Apache Airflow DAGs](#33-automated-apache-airflow-dags)
    - [3.4 Storage Connectors](#34-storage-connectors)
    - [3.5 Processing Contexts](#35-processing-contexts)
    - [3.6 Execution Configurations](#36-execution-configurations)

4. [Identifying Data Storage Locations](#4-identifying-data-storage-locations)

5. [Tracking Ownership and Metadata](#5-tracking-ownership-and-metadata)

6. [Estimating Runtime Patterns](#6-estimating-runtime-patterns)

7. [A Purpose-Built Large Language Model](#7-a-purpose-built-large-language-model)
